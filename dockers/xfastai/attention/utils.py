...
class HookBasedFeatureExtractor(nn.Module):
    ...
    def get_feature(self, m, i, o):
        self.final_feature = o.data.clone()
    ...
    def forward(self, x):
        ...
        f_out = self.submodule._modules.get('features').norm5.register_forward_hook(self.get_feature)
        # f_out = self.submodule._modules.get('features').denseblock4.denselayer16.conv2.register_forward_hook(self.get_feature)
        # print(f'f_out  type {type(self.submodule._modules.get("features"))}')
        self.submodule(x)
        h_inp.remove()
        h_out.remove()
        f_out.remove()
        ...
        return self.inputs, self.outputs, self.final_feature
